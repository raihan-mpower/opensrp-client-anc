    ...
    public static Map<String, String> getWomanProfileDetails(String baseEntityId) {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                detailsMap.put(DBConstants.KEY.Location, cursor.getString(cursor.getColumnIndex(DBConstants.KEY.Location)));//To Remove
